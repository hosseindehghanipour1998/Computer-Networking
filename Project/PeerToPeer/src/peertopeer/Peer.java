...
public class Peer {
    ...
    public static void main(String[] args) throws Exception {
        ...
        ServerThread serverThread = new ServerThread(setupValues[1]); // sets the socket address.
        serverThread.start();
        ...
        try{
            ...
            while (flag){
                ...
                if (message.equals("e")){
                    ...
                    System.out.println("Your Message [" + username +"] -> [ " + message + "] [ " + stringWriter.toString() + "]");
            ...
            e.printStackTrace();
            System.out.println("In Peer Exception 2");
        }
    }
}
